...
<div class="form-container">
        <table class="comment-table">
            ...
            <tr>
                <td>
                    <textarea class="comment-input" name="comment_supervisor" rows="4" cols="50" readonly><?php echo $reportDetails['comment_supervisor']; ?></textarea>
                    <?php if (!$alreadyApproved && $reportDetails['comment_supervisor'] === null) : ?>
                        <p>The company supervisor hasn't approved this report yet.</p>
                    <?php endif; ?>
                </td>
            </tr>
        </table>
